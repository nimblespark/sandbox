  ...
  _createClass(Keyboard, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        var isHighlighted = !_this.props.disabled && _this.props.highlightedNotes.includes(midiNumber);
...
function (_React$Component) {
  ...
  function Piano() {
    ...
    _defineProperty(_assertThisInitialized(_this), "highlightedNotes", {
  ...
  _createClass(Piano, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.highlightedNotes !== this.props.highlightedNotes) {
        this.setState({
          highlightedNotes: this.props.highlightedNotes || []
        });
      }
